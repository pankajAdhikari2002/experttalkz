  ...
  return (
    <>
      ...
      <section className="relative w-full h-[60vh] min-h-[500px] flex items-center">
        <div className="absolute inset-0 w-full h-full bg-cover bg-center" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBuRYsxJU2C5GqSbQF0Qi1ULec_m0DmC6xKn20xFsQ7kbgdJyR3yPOfAe6t8lJ6MgDwxsRYWLe4oy2BrYRBpTZkRmscjqa-GtUaQLAmzrgAzppQeKoIsUmAUiB8QxoKYhfCVdO6og5nVNpLJ6GFIZsrz6tNjfb2usIUHVRjfHK_c8d8nn32qyXsFL3nbt3P2Ny6DfIL8XOekiEcqvZqgh4g_YGM5y3QxnIF735NenkPZ48ksT4TjGVNDmSAdhXVOY596Hltp7lBjHUV")' }}></div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 pt-24 pb-16 md:pt-32 md:pb-24">
          <div className="max-w-2xl flex flex-col gap-6">
            ...
            <h1 className="text-4xl md:text-6xl font-black leading-tight tracking-tight text-white drop-shadow-lg">
              Mastering Data<br/>Science 2024
            </h1>
